...
void lv_port_disp_init(void)
{
    ...
    // 问题 1： 为什么最小缓冲区只能是 屏幕的一行， 不能更小 ？？？
    static lv_color_t buf2_1[LV_HOR_RES_MAX * 20];                      /*A buffer for 10 rows*/
		static lv_color_t buf2_2[LV_HOR_RES_MAX * 20];                      /*An other buffer for 10 rows (optional)*/
    lv_disp_buf_init(&disp_buf_1, buf2_1, buf2_2, LV_HOR_RES_MAX * 20);   /*Initialize the display buffer*/
