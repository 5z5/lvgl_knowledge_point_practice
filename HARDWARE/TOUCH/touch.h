...
#define T_PEN_GPIO_CLK_ENABLE()         do{ RCC_APB2PeriphClockCmd(	RCC_APB2Periph_GPIOF, ENABLE ); }while(0)   /* 所在IO口时钟使能 */

#define T_CS_GPIO_PORT                  GPIOF
#define T_CS_GPIO_PIN                   GPIO_Pin_11
#define T_CS_GPIO_CLK_ENABLE()          do{ RCC_APB2PeriphClockCmd(	RCC_APB2Periph_GPIOF, ENABLE ); }while(0)   /* 所在IO口时钟使能 */

#define T_MISO_GPIO_PORT                GPIOB
#define T_MISO_GPIO_PIN                 GPIO_Pin_2
#define T_MISO_GPIO_CLK_ENABLE()        do{ RCC_APB2PeriphClockCmd(	RCC_APB2Periph_GPIOB, ENABLE ); }while(0)   /* 所在IO口时钟使能 */

#define T_MOSI_GPIO_PORT                GPIOF
#define T_MOSI_GPIO_PIN                 GPIO_Pin_9
#define T_MOSI_GPIO_CLK_ENABLE()        do{ RCC_APB2PeriphClockCmd(	RCC_APB2Periph_GPIOF, ENABLE ); }while(0)   /* 所在IO口时钟使能 */

#define T_CLK_GPIO_PORT                 GPIOB
#define T_CLK_GPIO_PIN                  GPIO_Pin_1
#define T_CLK_GPIO_CLK_ENABLE()         do{ RCC_APB2PeriphClockCmd(	RCC_APB2Periph_GPIOB, ENABLE ); }while(0)   /* 所在IO口时钟使能 */
